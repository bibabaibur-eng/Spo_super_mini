...
// --------------------------------------------------------------------------
#define BATTERY_PIN        1  // Наприклад, аналоговий пін, куди підключений дільник (заміни на свій реальний пін, якщо це інший)
#define ADC_MULTIPLIER     1.83 // Коефіцієнт дільника (зміни під свої номінали резисторів, якщо потрібно)
